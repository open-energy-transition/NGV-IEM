...
col_sq = df_sq.columns[0]
col_iem = df_iem.columns[0]
...
# Apply the function
agg_sq = aggregate_rest_of_eu(df_sq, col_sq, target_zone, rest_eu_label, total_label)
agg_iem = aggregate_rest_of_eu(df_iem, col_iem, target_zone, rest_eu_label, total_label)
